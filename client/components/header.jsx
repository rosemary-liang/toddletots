...
export default function Header() {
  return (
    <header>
      <nav>
        <div className="container bg-primary h1 d-flex justify-content-between align-items-center mt-2">
          ...
          <div className="title-logo-container d-flex flex-row">
            <div className="trees-logo-container position-relative mx-4 h1">
            ...
            <p className="h1 fw-bold mt-1 text-white">ToddleTots</p>
          </div>
          <div className="user">
